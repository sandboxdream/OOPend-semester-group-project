...
package shape.bounceboxframework;
...
public abstract class Shape implements Drawable, Moveable {
    ...
    public void handle(String[] args) {
        ...
        if (args.length == 0)
            return;
        double vx = Double.parseDouble(args[0]), vy = Double.parseDouble(args[1]);
        ...
        if (r < 0 || r > 255 || g < 0 || g > 255 || b < 0 || b > 255) {
            throw new IllegalArgumentException("The color is out of range. [0,255]: r=" + r + ", g=" + g + ", b=" + b);
        }
