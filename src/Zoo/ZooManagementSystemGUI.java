...
public class ZooManagementSystemGUI extends JFrame {
    ...
    private void moveAnimal() {
        ...
        confirmButton.addActionListener(e -> {
            ...
            if (animalName.isEmpty()) {
                JOptionPane.showMessageDialog(moveDialog, "Please enter an animal name.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            // Determine source and destination zoos
            Zoo sourceZoo = southernSourceButton.isSelected() ? southernZone : northernZone;
            Zoo destZoo = southernSourceButton.isSelected() ? northernZone : southernZone;
            
            // Check if animal exists in source zoo
            int index = sourceZoo.findAnimal(animalName);
            if (index == -1) {
                JOptionPane.showMessageDialog(moveDialog, "Animal not found in " + sourceZoo.getName(), "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private void createLogisticsDialog(Zoo sourceZoo, Zoo destZoo, String animalName) {
        ...
        JComboBox<Integer> numCaretakersCombo = new JComboBox<>(new Integer[]{1, 2, 3});
        ...
        numCaretakersCombo.addActionListener(e -> {
            int numCaretakers = (int) numCaretakersCombo.getSelectedItem();
            for (int i = 0; i < 3; i++) {
        ...
        confirmButton.addActionListener(e -> {
            try {
                ...
                JOptionPane.showMessageDialog(logisticsDialog, "Please enter valid numbers for costs.", "Error", JOptionPane.ERROR_MESSAGE);
            } catch (Exception ex) {
    ...
    private void addAnimal() {
        ...
        JComboBox<String> zooCombo = new JComboBox<>(new String[]{"Southern-Zone Zoo", "Northern-Zone Zoo"});
        ...
        addButton.addActionListener(e -> {
            try {
                ...
                if (result == -1) {
                    JOptionPane.showMessageDialog(addDialog, selectedZoo.getName() + " is full, cannot add more animals.", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    // Display updated zoo
                ...
                JOptionPane.showMessageDialog(addDialog, "Please enter a valid number for age.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    private void removeAnimal() {
        ...
        removeButton.addActionListener(e -> {
            ...
            if (name.isEmpty()) {
                JOptionPane.showMessageDialog(removeDialog, "Please enter an animal name.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (selectedZoo.getCounter() == 0) {
                JOptionPane.showMessageDialog(removeDialog, "No animals to remove from " + selectedZoo.getName(), "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (index == -1) {
                JOptionPane.showMessageDialog(removeDialog, "Animal '" + name + "' not found in " + selectedZoo.getName(), "Error", JOptionPane.ERROR_MESSAGE);
            } else {
    ...
    private void findAnimal() {
        ...
        findButton.addActionListener(e -> {
            ...
            if (name.isEmpty()) {
                JOptionPane.showMessageDialog(findDialog, "Please enter an animal name.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
